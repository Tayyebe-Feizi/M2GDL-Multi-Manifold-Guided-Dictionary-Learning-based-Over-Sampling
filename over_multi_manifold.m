function  [sorted_weight,sorted_data,sort_lable]=over_multi_manifold(data)
% Calculate the weighted combination of centrality and marginality in a multi-manifold approach
[r,~]=size(data); 
labels=data(:,end);

%% Mapping data with the neighborhood criterion
[manifold,all_data_map]=neighborhood_Measure_mm(data);
